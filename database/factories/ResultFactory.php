...
class ResultFactory extends Factory
{
     ...
     * @return array
     */
    #[ArrayShape(['status' => "int|null", 'time' => "int", 'event_id' => "int"])]
    ...
    {
        return $this->state(function (array $attributes, Competition $competition) use ($event) {
            return [
                'event_id' => $event->id,
                ...
                'competition_category_id' => DB::table('competition_categories')->where('competition_id', $competition->id)->inRandomOrder()->first()->id
            ];
        });
    }
}
