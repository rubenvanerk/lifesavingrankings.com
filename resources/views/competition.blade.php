...
@section('content')
    <div class="grid grid-cols-3 gap-x-5">
                ...
                <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                    <div class="sm:col-span-1">
                        ...
                        <dd class="mt-1 text-sm text-gray-900">
                            <time datetime="2021-09-20">Sep 12 2016</time><x-heroicon-s-arrow-sm-right class="h-5 pb-0.5 inline mx-0.5"/><time datetime="2021-09-20">Sep 16 2016</time>
                        </dd>
                    </div>
                    <div class="sm:col-span-1">
                        <dt class="text-sm font-medium text-gray-500">
                        ...
                        <dd class="mt-1 text-sm text-gray-900">
                            <ul class="border border-gray-200 rounded-md divide-y divide-gray-200">
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                                    ...
                                    <div class="ml-4 flex-shrink-0">
                                        <a href="#" class="font-medium text-blue-700 hover:text-blue-500 flex items-center">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg" x-data="{ venueTab: 'pool' }">
            <div class="sm:hidden">
            ...
            <div class="hidden sm:block">
                <nav class="relative z-0 shadow flex divide-x divide-gray-200" aria-label="Tabs">
                    ...
                    <a href="#" aria-current="page"
                       @click="venueTab = 'pool'" :class="venueTab == 'pool' ? 'text-gray-900' : 'text-gray-500'"
                    ...
                    <a href="#"
                       @click="venueTab = 'beach'" :class="venueTab == 'beach' ? 'text-gray-900' : 'text-gray-500'"
                ...
                <dl class="sm:divide-y sm:divide-gray-200" x-show="venueTab == 'pool'">
                    ...
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 flex">
                            <img class="w-5 h-5 rounded-md mr-1" src="{{ url('/pragmarx/countries/flag/download/nld.svg') }}">
                            Netherlands
                        </dd>
                    </div>
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
